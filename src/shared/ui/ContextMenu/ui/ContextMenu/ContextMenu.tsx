...
const ContextMenuItemComponent = ({ item }: { item: ContextMenuItem }) => {
  ...
  return (
    <label
      key={item.id}
      htmlFor={htmlId}
      className={classNames(cls.contextMenuItem, {
    ...
    >
      ...
      <div className={cls.contextMenuItemText}>
        <div className={cls.contextMenuItemTextContent}>
          <p
            className={classNames(cls.contextMenuItemText, {
        ...
        {item.subContent && (
          <div className={cls.contextMenuItemSubContent}>{item.subContent}</div>
        )}
      </div>
      {item.children && (
        <div className={cls.contextMenuItemChildrenWrapper}>
